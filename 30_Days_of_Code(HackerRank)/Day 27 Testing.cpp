...
public:
    static vector<int> get_array() {
        ...
        UniqueValue.push_back(5);
        UniqueValue.push_back(10);
...
public:
    static vector<int> get_array() {
        vector<int> TwoDifferentMinimums;

        TwoDifferentMinimums.push_back(2);
        TwoDifferentMinimums.push_back(1);
        TwoDifferentMinimums.push_back(3);
        TwoDifferentMinimums.push_back(4);
        TwoDifferentMinimums.push_back(1);

        return TwoDifferentMinimums;
    }
